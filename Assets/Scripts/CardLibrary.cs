...
public class CardLibrary
{
    ...
    void Init()
    {
        ...
        cardList.Add(new LibraryCard(500, "Dummy", 10, 1, 10, 1, 0, LibraryCard.Cult.greed, LibraryCard.Race.none));
        ...
        cardList.Add(new LibraryCard(300, "leader_buff", 0, 0, 0, 0, 0, LibraryCard.Cult.none, LibraryCard.Race.none));
